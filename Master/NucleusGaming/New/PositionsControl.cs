...
namespace Nucleus.Coop
{
    public class PositionsControl : UserInputControl, IDynamicSized
    {
        ...
        {
            //SetStyle(ControlStyles.Opaque,false); nedd settings option
            base.OnMouseUp(e);
            Cursor = hand_Cursor;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = 0; i < screens.Length; i++)
            {
                ...
                Rectangle scrIndexRect = new Rectangle((int)s.UIBounds.Right-20, (int)s.UIBounds.Y,20,20);
                ...
                {
                    if (screens[i] == scr)
                        g.DrawString((screenPriority.IndexOf(scr) + 1).ToString(), extraSmallTextFont, Brushes.MediumSeaGreen, scrIndexRect, centerStr);
                }
