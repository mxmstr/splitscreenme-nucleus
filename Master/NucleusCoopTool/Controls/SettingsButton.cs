...
{
    public partial class SettingsButton : BufferedClientAreaPanel
    {
        ...
        public SettingsButton(MainForm mainform, int width, int height)
        {
            mainForm = mainform;
            InitializeComponent();
            ...
            btn_SettingsButtonPb = new PictureBox()
            {
                ...
                Cursor = mainForm.hand_Cursor,
                BackgroundImage = ImageCache.GetImage(Globals.ThemeFolder + "title_settings.png")
            };
