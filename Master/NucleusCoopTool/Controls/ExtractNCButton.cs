...
{
    public partial class ExtractNCButton : BufferedClientAreaPanel
    {
        ...
        public ExtractNCButton(MainForm mainform, int width, int height)
        {
            mainForm = mainform;
            InitializeComponent();
            ...
            btn_SettingsButtonPb = new PictureBox()
            {
                ...
                Cursor = mainForm.hand_Cursor,
                BackgroundImage = ImageCache.GetImage(Globals.ThemeFolder + "extract_nc.png")
            };
