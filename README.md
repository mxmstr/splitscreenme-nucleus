...
If you would like to learn all about contributing to this project, whether bug reporting or working on the codebase, check out the [Nucleus Coop Contributing Guide](CONTRIBUTING.md)!
